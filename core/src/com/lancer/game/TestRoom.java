...
class TestRoom extends Room {
    public TestRoom() {
        ...
        public void init () {
         ...
         //   Door rightdoor=new Door(Gdx.graphics.getWidth()/2+200,(Gdx.graphics.getHeight()-720)/2,40,40,null);
           // Door cur=new Door(Gdx.graphics.getWidth()/2,(Gdx.graphics.getHeight()-720)/2,40,40,rightdoor);
           Door Door_Up=new Door(0);
           // Door Door_Right=new Door(1);
          //  Door Door_Down=new Door(2);
           // Door Door_Left=new Door(3);
            add(p);
